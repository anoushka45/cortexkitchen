...
_DIGEST_SYSTEM_PROMPT = (
    ...
    "Write one line per relevant headline (plain text, no markdown headers), each "
    "stating the specific fact (a number, a policy, a named ingredient) and a concrete "
    "operational implication -- not generic advice like 'monitor the situation'. Do not "
    "pad to reach a target count: if only 1-2 headlines genuinely qualify, write only "
    "those; if none qualify, write exactly \"No restaurant-relevant trends this week.\"\n\n"
