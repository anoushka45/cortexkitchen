...
const SUGGESTIONS = [
  { category: "Quality",    hue: "#38bdf8", icon: "◆", q: "Which run had the lowest critic score and why?" },
  { category: "Complaints", hue: "#fb7185", icon: "◈", q: "What are the most common complaints recently?" },
  { category: "Inventory",  hue: "#a855f7", icon: "◉", q: "Which ingredients are flagged as low stock most often?" },
  { category: "Menu",       hue: "#34d399", icon: "◇", q: "Which items are highlighted across multiple runs?" },
  { category: "Demand",     hue: "#818cf8", icon: "◎", q: "Which scenario had the highest predicted orders?" },
  { category: "Strategy",   hue: "#B0621A", icon: "◐", q: "If I had to focus on one thing to improve our score, what would it be?" },
];
