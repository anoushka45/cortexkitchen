      ...
      <div className="max-w-2xl mx-auto">
        ...
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={saving}
            className="w-full bg-ember-600 hover:bg-ember-500 disabled:opacity-50 text-[var(--color-text-primary)] font-semibold rounded-lg py-2 text-sm transition-colors"
          >
