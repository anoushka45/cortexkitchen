...
const CONTEXT_CHIPS = [
  "Holiday", "Rain", "Low Stock", "Private Event",
  "Delivery Surge", "Staff Shortage", "Festival", "VIP Guests",
];

// What every run already draws on regardless of what's typed/spoken above --
// a trust strip, not a repeat of the specialist explainer that's already on
// /planning's own page.
const PLANNING_WITH = ["Reservations", "Weather", "Inventory", "Guest Feedback", "Market Intelligence", "Menu Performance"];
        ...
        <div className="card flex h-full flex-col overflow-hidden rounded-3xl border-[var(--color-border-default)] shadow-2xl animate-[modalIn_0.2s_ease-out_both]">
          <div className="flex items-start justify-between gap-4 border-b border-[var(--color-border-soft)] bg-[var(--color-surface-raised)] px-6 py-5">
            <div>
              ...
              <p className="mt-1 text-[13px] text-[var(--color-text-soft)]">Everything else — weather, reservations, inventory, market signals — it already has.</p>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="flex-1 overflow-y-auto px-6 py-6">
            ...
            <div className="mt-2 grid grid-cols-2 gap-2.5">
              ...
              >
                <div className="flex items-center gap-1.5">
                  <p className={`text-[13.5px] font-bold ${planFor === "next_service" ? "text-[var(--color-accent)]" : "text-[var(--color-text-primary)]"}`}>Next Service</p>
                ...
                <p className="mt-1 text-[11.5px] leading-relaxed text-[var(--color-text-faint)]">The AI figures out whether that means lunch, dinner, or the full day.</p>
              </button>
              <button
                type="button"
            ...
            <div className="mt-6">
              ...
              <textarea
                ...
                placeholder="e.g. we're hosting a corporate event with 120 guests, two chefs are absent, and we're low on mozzarella…"
                rows={4}
