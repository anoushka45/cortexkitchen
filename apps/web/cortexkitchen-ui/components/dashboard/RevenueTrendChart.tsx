    ...
    <div style={{ height: 220 }}>
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={chartData} margin={{ top: 0, right: 8, left: 0, bottom: 0 }}>
          ...
          <Line type="monotone" dataKey="profit" name="Gross profit" stroke="#efa345" strokeWidth={2.5} dot={false} />
          <Line type="monotone" dataKey="revenue" name="Revenue" stroke="#efa345" strokeWidth={1.5} strokeDasharray="4 3" dot={false} />
        </LineChart>
      </ResponsiveContainer>
    </div>
  );
